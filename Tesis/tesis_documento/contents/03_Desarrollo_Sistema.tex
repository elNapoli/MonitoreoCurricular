...
\ref{Anexo A} caca caca  \ref{hola}
...
\subsection{Diseño e implementación}
	...
	El caso de uso “Ver historial curricular” ocurre cuando un usuario  desea  ver los cambios  curriculares que se le han aplicado a una carrera en particular. El caso de uso real “Ver historial curricular” se presenta en la Tabla \ref{Tabla_Caso_Uso_ver_historial}.
		...
		Cuando un usuario autentificado quiere ver el expediente curricular de una carrera,  se dirige a la sección correspondiente, esta sección, denominada \textit{HistorialCurricular.aspx}
		
		antes de cargar el formulario, HistorialCurricular.aspx se encarga  eliminar
	\subsubsection{Metodología}
