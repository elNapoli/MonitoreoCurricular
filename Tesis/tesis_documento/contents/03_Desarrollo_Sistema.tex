...
\subsection{Diseño e implementación}
	...
	escribir descripción del modulo
		\myparagraph{Diseño}
		
		A continuación se describe el diseño los casos de usos para el módulo de gestión de documentos de la plataforma, que corresponden a: subir documentos, ver documentos y eliminar documentos. Se presentará en detalle la composición de estos casos de uso y su participación en el sistema.
		
		\mysubparagraph{ Casos de usos reales del módulo gestor de documentos} 
		




		El caso de uso ``Subir documento'' ocurre cuando un administrador o un editor desea crear algún hito curricular en un plan de estudios El caso de uso real ``Subir documento'' se presenta en la Tabla \ref{Tabla_Caso_Uso_Subir_Documento}.
			...
			\begin{longtable}{p{7cm}| p{7cm}}
				...
				&	2.- El sistema despliega la pantalla \textbf{A}, el cual permite al usuario  introducir información referente al encabezado del hito curricular.\\ \hline
				...
				& 8.- El sistema  por cada documento  agrega a la interfaz gráfica los siguientes elementos; un DropDownList, el cual corresponde al tipo de documento que es; un input, donde el usuario ingresa el número del documento y por último un Label que indica el nombre del documento.\\ \hline
			...
			\end{longtable}
				...
				En la Figura \ref{diagrama_secuencial_Subir_documento} se presenta el diagrama de secuencia para este mismo caso de uso, y así mostrar la interacción entre los distintos componentes del software que llevan a cabo esta tarea.
