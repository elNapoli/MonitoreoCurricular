...
\hspace{-1cm}{\fontsize{11}{11}\selectfont DOCTORADO EN SOFTWARE Y SISTEMAS}\\
\vspace{0.5cm}
...
\vspace{0.5cm}
\hspace{-1cm}{\fontsize{11}{11}\selectfont PROFESOR INFORMANTE:}\\
\hspace{-1cm}{\fontsize{11}{11}\selectfont JORGE MORALES VILUGRON}\\
\hspace{-1cm}{\fontsize{11}{11}\selectfont INGENIERIO EN ELECTRICIDAD}\\
\end{flushleft}
...
\input{contents/02_Marco_Teorico.tex}
...
\input{contents/03_Desarrollo_Sistema.tex}
...
\input{contents/04_Implementacion_prototipo.tex}

\newpage
%----------------------------------------------------------
%----------------------------------------------------------
\section{VALIDACIÓN DE LA PLATAFORMA}
\input{contents/validacion.tex}
...
\input{contents/05_conclusiones.tex}
...
%----------------------------------------------------------
\section{REFERENCIAS}
\input{contents/Bibliografia.tex}
